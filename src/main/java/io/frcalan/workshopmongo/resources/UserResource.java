...
public class UserResource {
    ...
    public ResponseEntity<List<UserDTO>> findAll() {
        ...
        List<UserDTO> listDTO = list.stream().map(user -> new UserDTO(Optional.ofNullable(user))).collect(Collectors.toList());
    ...
    public ResponseEntity<UserDTO> findById(@PathVariable String id) {
        ...
        return ResponseEntity.ok().body(new UserDTO(Optional.ofNullable(user)));
    }
}
